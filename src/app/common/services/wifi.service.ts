...
export class WifiService {
  ...
  public addItem(params): Observable<any> {
    return this.http.post(`${this.globalService.urlt}/wifiProber/add`, params);
  }
  // 删除单个
  public deleteItem(id): Observable<any> {
    return this.http.get(`${this.globalService.urlt}/wifiProber/delete/${id}`);
  }
  // 删除多个
  public deleteList(params): Observable<any> {
    console.log(params);
    return this.http.post(`${this.globalService.urlt}/wifiProber/delete`, params);
  }
  // 修改
  public modifyList(params): Observable<any> {
    return this.http.post(`${this.globalService.urlt}/wifiProber/update`, params);
  }
  // 查询
  public searchList(num): Observable<any> {
    return this.http.post(`${this.globalService.urlt}/wifiProber/queryByPaging/${num.page}/${num.nums}`, {});
  }
  // 条件查询
  public searchWifi(num,body): Observable<any> {
    return this.http.post(`${this.globalService.urlt}/wifiProber/queryByPaging/${num.page}/${num.nums}`, body);
  }
  // 查询激活区域
