...
export class DictService {
  ...
  public searchDict(num,body): Observable<any> {
    return this.http.post(`${this.globalService.urls}/dictionary/queryByPaging/${num.page}/${num.nums}`, body);
  }
  ...
  public searchDictWord(num,body): Observable<any> {
    return this.http.post(`${this.globalService.urls}/dictionaryEntry/queryByPaging/${num.page}/${num.nums}`, body);
  }
  // 指定查询
